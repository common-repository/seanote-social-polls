...
function seanote_scripts() {
  wp_enqueue_style('seanote-css','https://seanote.com/static/css/embed.css');
  wp_enqueue_script( 'seanote-plugin','https://seanote.com/static/js/plugin.js', array('jquery'),'',true);
}
